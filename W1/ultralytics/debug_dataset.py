...
# Set the paths for your image and label directories
...
# Function to visualize an image and its ground truth labels
def visualize_image_with_labels(image_name, image_dir, label_dir):
    ...
    # Read the corresponding label file (same name as the image, but with .txt extension)
    ...
    # Read label file and parse the bounding boxes
    with open(label_path, 'r') as file:
        lines = file.readlines()

    # Loop through the lines in the label file and draw bounding boxes
    for line in lines:
        ...
        # Optional: Draw class label text
        label = str(class_id)
