...
# WandB init
wandb.init(project="C5_W3", entity="C3_MCV_LGVP", name="Fine Tune Llama-3.2-1B")
...
def train(model, train_dataloader, valid_dataloader, optimizer, scheduler, EPOCHS=10):
    ...
    for epoch in range(EPOCHS):
        ...
        os.makedirs("llama/model_1_1B", exist_ok=True)
        model.llama.save_pretrained(f"llama/model_1_1B/llama_finetuned_epoch_{epoch+1}")
        tokenizer.save_pretrained(f"llama/model_1_1B/llama_finetuned_epoch_{epoch+1}")
